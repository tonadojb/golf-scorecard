var I18N = {
  ko:{
    ...
    copyDatePrefix:"📅",
    copyTotalLabel:"합계",
    copyFooter:"- Tonado_GolfScoreCard -",
    ...
    friendsImportBtn:"📱 연락처에서 가져오기",
    friendsImportNativeOnly:"스마트폰 앱에서만 사용할 수 있어요.",
    friendsImportFail:function(msg){ return '연락처를 가져오지 못했습니다: ' + msg; },
    toastContactImported:"이름/연락처를 가져왔어요.",
    ...
    manualSubDesc:'로그인 계정당 평생 <b>20회</b>까지 사진 스캔을 무료로 쓸 수 있어요. 다 쓰면 <b>베이직</b>(매달 6회 스캔) 또는 <b>프로</b>(무제한 스캔) 중 골라 구독할 수 있고, 스마트폰 앱은 앱스토어 결제, PC·웹은 카드·카카오페이·네이버페이로 결제해요. 구독 안내 창에서 <b>구매 복원</b>·<b>구독 해지</b>도 언제든 가능해요.',
    ...
    manualFriendsTitle:"친구 관리 & 계좌 바로 복사",
    manualFriendsDesc:'오른쪽 아래 <b>👥 친구 관리</b> 버튼으로 자주 같이 치는 사람의 이름·연락처·은행·계좌번호·메모를 저장해두세요. 내기 정산 결과에 저장된 이름과 같은 이름이 나오면 <b>📋 계좌복사</b> 버튼이 함께 떠서 계좌번호만 바로 복사할 수 있어요. 동명이인이 여러 명 등록돼 있으면 메모·연락처로 구분해서 고를 수 있고, 스마트폰 앱에서는 <b>📱 연락처에서 가져오기</b> 버튼으로 아이폰 연락처의 이름·전화번호를 바로 불러올 수도 있어요.',
    ...
    manualStatsDesc:'불러오기 창 위쪽의 <b>📊 내 스코어 통계</b> 버튼을 누르면 최근 10회 · 20회 · 전체 기준으로 평균/베스트 스코어, 평균 오버파, 파 · 보기 · 더블보기 이상 비율을 한눈에 볼 수 있어요. 그 아래 <b>🆚 동반자 비교</b>에서는 자주 같이 친 동반자를 골라 상대전적(승/패/무)과 평균·베스트 스코어를 비교할 수 있어요.',
    ...
    vsSectionTitle:"🆚 동반자 비교",
    vsSelectPlaceholder:"동반자를 선택하세요",
    vsNoCompanions:"함께 라운드한 동반자 기록이 없습니다.",
    vsRecordLine:function(name, rounds, wins, losses, ties){ return name + '님과 ' + rounds + '전 ' + wins + '승 ' + losses + '패 ' + ties + '무'; },
    vsMyAvg:"내 평균",
    vsOppAvg:"상대 평균",
    vsMyBest:"내 베스트",
    vsOppBest:"상대 베스트",
    ...
    referralCopyBtn:"복사",
    referralCopied:"추천 링크가 복사되었습니다!",
    referralCopyFail:"복사에 실패했습니다",
    referralHowItWorks:function(n){ return "친구 "+n+"명을 추천하면 룰렛 1회를 돌릴 수 있어요 (이후에도 "+n+"명마다 계속 추가돼요)"; },
    referralProgressLabel:function(confirmed, remaining){ return "확정된 추천 "+confirmed+"명 · 다음 룰렛까지 "+remaining+"명 남음"; },
    referralSpinsAvailable:function(n){ return "사용 가능한 룰렛: "+n+"회"; },
    referralSpinBtn:"룰렛 돌리기",
    referralSpinning:"룰렛을 돌리는 중...",
    referralSpinNoChance:"사용 가능한 룰렛 기회가 없어요",
    referralSpinFail:function(msg){ return "룰렛 실행에 실패했습니다: "+msg; },
    referralSpinResult:function(label){ return "🎉 당첨: "+label+"!"; },
  ...
  en:{
    ...
    friendsImportBtn:"📱 Import from contacts",
    friendsImportNativeOnly:"Only available in the smartphone app.",
    friendsImportFail:function(msg){ return 'Failed to import contact: ' + msg; },
    toastContactImported:"Name/phone imported.",
    ...
    manualSubDesc:'Each account gets <b>20</b> free photo scans for life. Once used up, subscribe to <b>Basic</b> (6 scans/month) or <b>Pro</b> (unlimited scans) -- paid via the App Store on the smartphone app, or by card/KakaoPay/NaverPay on PC/web. You can <b>restore a purchase</b> or <b>cancel your subscription</b> anytime from the subscription screen.',
    ...
    manualFriendsTitle:"Friends & Instant Account Copy",
    manualFriendsDesc:'Tap the <b>👥 Friends</b> button in the bottom right to save the name/phone/bank/account/memo of people you often play with. When a saved name shows up in a settlement result, a <b>📋 Copy account</b> button appears so you can copy just the account number. If more than one friend shares that name, pick the right one by memo or phone number. In the smartphone app, you can also tap <b>📱 Import from contacts</b> to pull a name/phone number straight from your iPhone contacts.',
    ...
    manualStatsDesc:'Tap <b>📊 My Score Stats</b> at the top of the Load window to see your average/best score, average over par, and the ratio of par/bogey/double-bogey-or-worse at a glance, for the last 10, last 20, or all rounds. Below that, <b>🆚 Head-to-Head</b> lets you pick a frequent playing partner and compare your record (wins/losses/ties) and average/best scores against them.',
    ...
    vsSectionTitle:"🆚 Head-to-Head",
    vsSelectPlaceholder:"Choose a playing partner",
    vsNoCompanions:"No rounds played together yet.",
    vsRecordLine:function(name, rounds, wins, losses, ties){ return rounds + ' rounds vs ' + name + ': ' + wins + 'W ' + losses + 'L ' + ties + 'T'; },
    vsMyAvg:"My Average",
    vsOppAvg:"Their Average",
    vsMyBest:"My Best",
    ...
    referralCopyFail:"Failed to copy",
    referralHowItWorks:function(n){ return "Refer "+n+" friends to get 1 roulette spin (every "+n+" more referrals gives another spin)"; },
    referralProgressLabel:function(confirmed, remaining){ return confirmed+" confirmed referrals · "+remaining+" more until your next spin"; },
    referralSpinsAvailable:function(n){ return "Spins available: "+n; },
    referralSpinBtn:"Spin the roulette",
    referralSpinning:"Spinning...",
    referralSpinNoChance:"You have no spins available",
    referralSpinFail:function(msg){ return "Spin failed: "+msg; },
    referralSpinResult:function(label){ return "🎉 You won: "+label+"!"; },
  ...
  ja:{
    ...
    friendsImportBtn:"📱 連絡先から読み込み",
    friendsImportNativeOnly:"スマートフォンアプリでのみご利用いただけます。",
    friendsImportFail:function(msg){ return '連絡先の読み込みに失敗しました: ' + msg; },
    toastContactImported:"名前/連絡先を読み込みました。",
    ...
    manualSubDesc:'アカウントごとに生涯<b>20回</b>まで写真スキャンを無料で使えます。使い切ったら<b>ベーシック</b>(毎月6回スキャン)または<b>プロ</b>(無制限スキャン)を選んで登録でき、スマートフォンアプリはApp Store決済、PC・Webはカード・Kakao Pay・Naver Payで決済します。サブスクリプション画面から<b>購入の復元</b>・<b>解約</b>もいつでも可能です。',
    ...
    manualFriendsTitle:"友達管理 & 口座番号すぐコピー",
    manualFriendsDesc:'右下の<b>👥 友達管理</b>ボタンから、よく一緒にプレーする人の名前・連絡先・銀行・口座番号・メモを保存しておけます。精算結果に保存した名前と同じ名前が出ると<b>📋 口座コピー</b>ボタンが一緒に表示され、口座番号だけすぐコピーできます。同じ名前の友達が複数登録されている場合はメモ・連絡先で区別して選べ、スマートフォンアプリでは<b>📱 連絡先から読み込み</b>ボタンでiPhoneの連絡先から名前・電話番号をそのまま読み込むこともできます。',
    ...
    manualStatsDesc:'読み込みウィンドウ上部の<b>📊 マイスコア統計</b>ボタンを押すと、直近10回・20回・全体を基準に平均/ベストスコア、平均オーバーパー、パー・ボギー・ダブルボギー以上の割合を一目で確認できます。その下の<b>🆚 同伴者比較</b>では、よく一緒にプレーする同伴者を選んで対戦成績(勝敗分)と平均・ベストスコアを比較できます。',
    ...
    vsSectionTitle:"🆚 同伴者比較",
    vsSelectPlaceholder:"同伴者を選んでください",
    vsNoCompanions:"一緒にラウンドした同伴者の記録がありません。",
    vsRecordLine:function(name, rounds, wins, losses, ties){ return name + 'さんとは' + rounds + '戦 ' + wins + '勝 ' + losses + '敗 ' + ties + '分'; },
    vsMyAvg:"自分の平均",
    vsOppAvg:"相手の平均",
    vsMyBest:"自分のベスト",
    vsOppBest:"相手のベスト",
    ...
    referralCopyBtn:"コピー",
    referralCopied:"紹介リンクをコピーしました!",
    referralCopyFail:"コピーに失敗しました",
    referralHowItWorks:function(n){ return "友達"+n+"人を紹介するとルーレットを1回回せます(その後も"+n+"人ごとに追加されます)"; },
    referralProgressLabel:function(confirmed, remaining){ return "確定紹介"+confirmed+"人 · 次のルーレットまであと"+remaining+"人"; },
    referralSpinsAvailable:function(n){ return "使用可能なルーレット: "+n+"回"; },
    referralSpinBtn:"ルーレットを回す",
    referralSpinning:"ルーレットを回しています...",
    referralSpinNoChance:"使用可能なルーレットがありません",
    referralSpinFail:function(msg){ return "ルーレット実行に失敗しました: "+msg; },
    referralSpinResult:function(label){ return "🎉 当選: "+label+"!"; },
  ...
  zh:{
    ...
    friendsImportBtn:"📱 从通讯录导入",
    friendsImportNativeOnly:"仅在手机应用中可用。",
    friendsImportFail:function(msg){ return '导入联系人失败: ' + msg; },
    toastContactImported:"已导入姓名/联系方式。",
    ...
    manualSubDesc:'每个账号终身可免费使用<b>20次</b>照片扫描。用完后可订阅<b>基础版</b>(每月6次扫描)或<b>专业版</b>(无限扫描),手机应用通过App Store付款,电脑/网页版可用信用卡·KakaoPay·NaverPay付款。在订阅页面随时可以<b>恢复购买</b>或<b>取消订阅</b>。',
    ...
    manualFriendsTitle:"好友管理 & 一键复制账号",
    manualFriendsDesc:'点击右下角<b>👥 好友管理</b>按钮,保存常一起打球的人的姓名·联系方式·银行·账号·备注。结算结果中出现与已保存姓名相同的名字时,会显示<b>📋 复制账号</b>按钮,可以只复制账号。若同名好友有多个,可用备注·联系方式区分选择;在手机应用中还可以点击<b>📱 从通讯录导入</b>按钮,直接从iPhone通讯录导入姓名·电话号码。',
    ...
    manualStatsDesc:'点击加载窗口上方的<b>📊 我的成绩统计</b>按钮,即可一目了然地查看最近10次·20次·全部的平均/最佳成绩、平均超标杆数,以及标准杆·柏忌·双柏忌以上的比例。下方的<b>🆚 球伴对比</b>可以选择常同场的球伴,比较对战战绩(胜/负/平)和平均·最佳成绩。',
    ...
    vsSectionTitle:"🆚 球伴对比",
    vsSelectPlaceholder:"请选择球伴",
    vsNoCompanions:"暂无与球伴同场的记录。",
    vsRecordLine:function(name, rounds, wins, losses, ties){ return '与' + name + '交手' + rounds + '次: ' + wins + '胜 ' + losses + '负 ' + ties + '平'; },
    vsMyAvg:"我的平均",
    vsOppAvg:"对方平均",
    vsMyBest:"我的最佳",
    vsOppBest:"对方最佳",
    ...
    referralCopyFail:"复制失败",
    referralHowItWorks:function(n){ return "推荐"+n+"位好友即可转动1次轮盘(之后每再推荐"+n+"位继续增加)"; },
    referralProgressLabel:function(confirmed, remaining){ return "已确认推荐"+confirmed+"位 · 距下次转盘还差"+remaining+"位"; },
    referralSpinsAvailable:function(n){ return "可用转盘次数: "+n+"次"; },
    referralSpinBtn:"转动轮盘",
    referralSpinning:"轮盘转动中...",
    referralSpinNoChance:"没有可用的转盘次数",
    referralSpinFail:function(msg){ return "转动轮盘失败: "+msg; },
    referralSpinResult:function(label){ return "🎉 中奖: "+label+"!"; },
