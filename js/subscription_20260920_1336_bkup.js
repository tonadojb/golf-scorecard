(function(){
  ...
  /* 포트원(PortOne) 콘솔(https://admin.portone.io/integration-v2/manage/channel)의
     ...
     반드시 정확히 같은 값이어야 합니다. */
  var PORTONE_STORE_ID = "store-xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx";
  var PORTONE_CHANNEL_KEY = "channel-key-xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx";
  ...
  function purchaseWeb(plan, statusEl){
    ...
    window.PortOne.requestIssueBillingKey({
      ...
      issueName: plan === "pro" ? "골프 스코어카드 프로 구독" : "골프 스코어카드 베이직 구독",
